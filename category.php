						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="post post-thumb">
									<a class="post-img" href="blog-post.php?id_p=<?=$dataCate['id']?>"><img src="./img/<?=$dataCate['thumbnail']?>" alt=""></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-2" href="#"><?=$dataCate['category']?></a>
											<span class="post-date"><?=$dataCate['created_at']?></span>
										</div>
										<h3 class="post-title"><a href="blog-post.php?id_p=<?=$dataCate['id']?>"><?=$dataCate['title']?></a></h3>
									</div>
								</div>
							</div> 
							<!-- /post -->
							...
							<div class="col-md-6">
								<div class="post">
									<a class="post-img" href="blog-post.php?id_p=<?=$dataCate3['id']?>"><img src="./img/<?=$dataCate3['thumbnail']?>" alt=""></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-2" href="#"><?=$dataCate3['category']?></a>
											<span class="post-date"><?=$dataCate3['created_at']?></span>
										</div>
										<h3 class="post-title"><a href="blog-post.php?id_p=<?=$dataCate3['id']?>"><?=$dataCate3['title']?></a></h3>
									</div>
								</div>
							</div>
						 	<?php } ?>
							...
							<div class="col-md-12">
								<div class="post post-row">
									<a class="post-img" href="blog-post.php?id_p=<?=$dataCate5['id']?>"><img src="./img/<?=$dataCate5['thumbnail']?>" alt=""></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-2" href="#"><?=$dataCate5['category']?></a>
											<span class="post-date"><?=$dataCate5['created_at']?></span>
										</div>
										<h3 class="post-title"><a href="blog-post.php?id_p=<?=$dataCate5['id']?>"><?=$dataCate5['title']?></a></h3>
